...
The `ultimategdbot.util` package is for reusable static helper functions shared across the codebase. It has no strict class structure requirements — unlike services or commands, util classes are free-form.
...
- Place any formatting helpers, embed templates, Discord interaction utilities, or other cross-cutting pure functions here.
